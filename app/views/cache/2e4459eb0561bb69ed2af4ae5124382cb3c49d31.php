...
<body>
   ...
   <nav aria-label="Page navigation example">
      <ul class="pagination">
         <li class="page-item"><a class="page-link" href="index.php?controller=tareas&action=verPendientePaginacion&pagina=<?php echo e($pagina-1); ?>">Anterior</a></li>
         <?php for($i = 1; $i <= $paginas; $i++): ?> <li class="page-item"><a class="page-link" href="index.php?controller=tareas&action=verPendientePaginacion&pagina=<?php echo e($i); ?>"><?php echo e($i); ?></a></li>
            <?php endfor; ?>
            <li class="page-item"><a class="page-link" href="index.php?controller=tareas&action=verPendientePaginacion&pagina=<?php echo e($pagina+1); ?>">Siguiente</a></li>
      </ul>
   </nav>
